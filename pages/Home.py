...
# En-tête
st.markdown("<h1 class='main-title'>🏥 Projet d'analyse et de prédiction hospitalière</h1>", unsafe_allow_html=True)
...
# Placeholder pour GIF d'introduction
st.markdown("### 🎥 Aperçu de l'application")
st.info("Emplacement pour GIF de démonstration de l'application")

# Sections principales
st.markdown('<h2 class="section-title">📊 Fonctionnalités principales</h2>', unsafe_allow_html=True)
...
# Guide d'utilisation
st.markdown('<h2 class="section-title">📚 Comment utiliser l\'application</h2>', unsafe_allow_html=True)
...
st.markdown('<h2 class="section-title">📊 Sources des données</h2>', unsafe_allow_html=True)
st.markdown("""
    <div class="feature-card">
