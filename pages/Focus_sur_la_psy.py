...
if df is not None:
    ...
    search_term = st.text_input("🔍 Rechercher une pathologie psychiatrique spécifique pour obtenir des détails", "")
    ...
    if search_term:
        ...
        if filtered_pathologies:
            ...
            col1, col2 = st.columns(2)
            with col1:
                st.metric("Nombre total d'hospitalisations en psychiatrie", f"{total_hospi:,.0f}")
            with col2:
    ...
    st.subheader("Évolution des pathologies psychiatriques (2018-2022)")
