...
chat = st.Page("pages/Votre_docteur_en_ligne.py", title="Votre docteur en ligne V1", icon="👨‍⚕️")
...
medecine = st.Page("pages/Focus_sur_la_medecine.py", title="Focus Médecine", icon="💊")
...
pg = st.navigation({
    ...
    "Vue par service médical": [chirurgie, medecine, obstetrique, psy, ssr],
    "Modèles prédictifs": [predictif],
    "Outils": [graphs, chat, chatSQL]
})
